...
import md3.Core
import md3.Extras.ReportDesigner 1.0
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Text {
                    text: "Drag-drop report designer with bindings, formulas, rich text, charts, tables and paginated detail sections."
